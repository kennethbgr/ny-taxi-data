...
PARQUET_FILE = "fhv_tripdata_{{ execution_date.strftime('%Y-%m') }}.parquet"
FHV_OUTPUT_FILE_TEMPLATE = AIRFLOW_HOME + "/" + PARQUET_FILE
TABLE_NAME_TEMPLATE = "fhv_tripdata_{{ execution_date.strftime('%Y_%m') }}"
FHV_GCS_PATH_TEMPLATE = "raw/fhv_tripdata/{{ execution_date.strftime('%Y') }}/" + PARQUET_FILE
...
with DAG(
    ...
    #             "sourceUris": [f"gs://{BUCKET}/{FHV_GCS_PATH_TEMPLATE}"],
    #         },
    #     },
    # )
